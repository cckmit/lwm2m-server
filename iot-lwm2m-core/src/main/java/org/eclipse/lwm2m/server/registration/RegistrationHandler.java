 ...
 *******************************************************************************/
package org.eclipse.lwm2m.server.registration;

import java.net.InetSocketAddress;
import java.util.Date;

import org.eclipse.lwm2m.core.request.DeregisterRequest;
...
import org.eclipse.lwm2m.core.response.DeregisterResponse;
...
import org.eclipse.lwm2m.util.RandomStringUtils;
...
public class RegistrationHandler {
    ...
    public Registration getByEndpoint(String endpoint, Object key) {
        return registrationService.getByEndpoint(endpoint, key);
    }

    public Object getValue(Object key) {
        return registrationService.getStore().getValue(key);
    }

    public SendableResponse<RegisterResponse> register(Identity sender, RegisterRequest registerRequest,
                                                       InetSocketAddress serverEndpoint, Object key) {
        ...
        final Deregistration deregistration = registrationService.getStore().addRegistration(registration, key);
        ...
        Runnable whenSent = new Runnable() {
            ...
            public void run() {
                if (deregistration != null) {
                    registrationService.fireUnregistered(deregistration.getRegistration(), deregistration.getObservations(), registration);
