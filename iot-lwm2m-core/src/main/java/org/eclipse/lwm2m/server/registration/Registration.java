...
public class Registration implements Serializable {
    ...
    public String toString() {
        return String.format(
                "Registration [registrationDate=%s, address=%s, port=%s, registrationEndpointAddress=%s, lifeTimeInSec=%s, smsNumber=%s, lwM2mVersion=%s, bindingMode=%s, endpoint=%s, registrationId=%s, objectLinks=%s, lastUpdate=%s]",
