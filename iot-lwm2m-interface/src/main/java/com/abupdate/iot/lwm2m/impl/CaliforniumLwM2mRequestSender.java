...
import org.eclipse.lwm2m.core.californium.AsyncRequestObserver;
import org.eclipse.lwm2m.core.californium.SyncRequestObserver;
...
public class CaliforniumLwM2mRequestSender implements LwM2mRequestSender {
    ...
    public <T extends LwM2mResponse> T send(final Registration destination, final DownlinkRequest<T> request,
        ...
        LOG.info("CoapRequestBuilder====>{}",coapRequestBuilder);
        ...
        LOG.info("coapRequest====>{}",coapRequest);
    ...
    private Endpoint getEndpointForClient(Registration registration) {
        ...
        throw new IllegalStateException("can't find the client endpoint for address : " + registration.getRegistrationEndpointAddress());
    }
}
